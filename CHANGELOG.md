...
### 🐞 Bug fixes
- Measure the fill-extrusion vertical wall gradient from the wall itself instead of the whole feature, so tall thin extrusions are not uniformly dark ([#6482](https://github.com/maplibre/maplibre-gl-js/issues/6482)) (by [@clement-igonet](https://github.com/clement-igonet))
