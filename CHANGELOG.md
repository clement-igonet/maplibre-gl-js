...
### 🐞 Bug fixes
- Fix an empty raster-DEM tile response (HTTP 204) breaking terrain and hillshade rendering with a "dem dimension mismatch" error; empty tiles are now treated as missing ([#1551](https://github.com/maplibre/maplibre-gl-js/issues/1551)) (by [@clement-igonet](https://github.com/clement-igonet))
