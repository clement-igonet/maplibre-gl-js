...
- Fix `fill-extrusion-vertical-gradient` disappearing on extrusions with a non-zero `fill-extrusion-base`, by running the gradient over the wall between base and height ([#6482](https://github.com/maplibre/maplibre-gl-js/issues/6482)) (by [@clement-igonet](https://github.com/clement-igonet))
- _...Add new stuff here..._
