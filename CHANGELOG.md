...
- Fix crashes when camera is inside terrain. Add padding between camera and surface to prevent cases like this. ([#1542](https://github.com/maplibre/maplibre-gl-js/issues/1542)) (by [@chrneumann](https://github.com/chrneumann))
- _...Add new stuff here..._
